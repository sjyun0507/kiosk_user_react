...
const KioskPage = ({ cartItems, setCartItems }) => {
    ...
    const [sparkleLevel, setSparkleLevel] = useState("보통"); //탄산
    ...
    // 옵션들을 type 별로 그룹화 (렌더링용)
    const groupOptionsByType = (type) => {
        return allOptionsRaw
            .filter((opt) => {
                            ...
                            <div className="flex justify-center gap-4 mt-6">
                                ...
                                <button
                                    onClick={() => {
                                        ...
                                        if (!isDessert && !["에이드", "주스", "스무디"].some(c =>
                                            categoryName.includes(c)) && !tempOption) {
                                            alert("온도를 선택해주세요.");
                                            return;
                                        }
